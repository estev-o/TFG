#!/usr/bin/env python3
"""Entrenamiento CNN con HPI ordinal y IVR como score continuo peces<->erizos."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train CNN with HPI CORAL-like ordinal head + IVR score head"
    )
    parser.add_argument("--train-csv", default="cnn/splits/train.csv")
    parser.add_argument("--val-csv", default="cnn/splits/val.csv")
    parser.add_argument("--out-dir", default="cnn/runs/baseline_hpi_coral_ivr_score")
    parser.add_argument(
        "--model",
...
class HpiCoralIvrScoreLoss(nn.Module):
    def __init__(
        self,
        target: str,
        num_classes_hpi: int,
...
def main() -> None:
    ...
    criterion = HpiCoralIvrScoreLoss(
        args.target,
