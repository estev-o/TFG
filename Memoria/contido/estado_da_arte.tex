...
A visión por computador é unha ferramenta de grande utilidade na
análise automática de imaxes biolóxicas, ao permitir a extracción de información cuantitativa a partir
de rexistros visuais de maneira máis rápida, reproducible e escalable que a inspección manual. Este
...
Entre as arquitecturas convolucionais recentes, ConvNeXt destaca por reformular o deseño dunha CNN
clásica incorporando decisións inspiradas nos \textit{Vision Transformers}, mantendo ao mesmo tempo a
natureza convolucional do modelo. Liu et al.~\cite{DBLP:journals/corr/abs-2201-03545} presentan esta
familia como unha actualización das CNN para competir coas arquitecturas modernas baseadas en atención,
o que a converte nunha alternativa relevante como extractor de características en tarefas de visión por
computador.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.90\textwidth]{imaxes/arquitecturas/arquitectura_convnext.png}
    \caption{Esquema xeral da arquitectura ConvNeXt descrita por Liu et al.~\cite{DBLP:journals/corr/abs-2201-03545}.}
    \label{fig:arquitectura-convnext}
\end{figure}

No caso da detección de obxectos, a familia de modelos YOLO, introducida por Redmon et
al.~\cite{DBLP:journals/corr/RedmonDGF15}, converteuse nunha das referencias máis
influentes do campo. A revisión de
Ramos e Sappa~\cite{articuloYOLO} analiza unha década de evolución
de YOLO, desde as primeiras versións ata arquitecturas máis recentes, destacando como trazos
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{imaxes/arquitecturas/arquitectura_yolov8.png}
    \caption{Esquema xeral dunha arquitectura YOLOv8, pertencente á familia YOLO introducida por Redmon et al.~\cite{DBLP:journals/corr/RedmonDGF15}.}
    \label{fig:arquitectura-yolov8}
\end{figure}
...
unha confusión entre niveis próximos e outra entre niveis afastados. Entre estes enfoques, CORAL-CNN \cite{articuloCoral}
...
Desde o punto de vista biolóxico, o traballo de Barrientos et al.~\cite{articuloBarrientosKelpCollapse}
resulta imprescindible para este TFG. Sara Barrientos de la Llana, primeira autora
dese estudo, pertencente ao grupo BIOCOST é unha das expertas que participou na reunión de validación descrita no
Capítulo~\ref{chap:conclusions}, analizou xunto con outros autores o colapso de bosques temperados
de \textit{kelp} no noroeste de España debido á herbivoría por peixes. O estudo mostra que as marcas
de mordedura e a súa atribución a distintos grupos de herbívoros son relevantes para comprender a
dinámica das poboacións de algas e a degradación dos arrecifes. A súa achega non é unha proposta de
automatización mediante visión por computador, pero si proporciona unha motivación directa para o
problema abordado neste traballo, que é dispoñer de ferramentas que axuden a cuantificar de maneira máis
rápida e consistente o dano por herbivoría e a súa posible procedencia. Ademáis, a partir de este estudo
xorde o \textit{dataset} que se emprega neste traballo.
